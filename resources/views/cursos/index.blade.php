        ...
        @foreach ($cursito as $co)
            ...
            <div class="col-sm">
                <div class="card" style="width: 16rem; margin-top:30px; ">
                    <center>
                        <img src="{{ Storage::url($co->img) }}" class="card-img-top" alt="..."
                            style="width: 250px; margin-top:30px; height:200px; padding:25px;">
                    </center>
                    <div class="card-body">
                        ...
                        <a href="/cursos/{{ $co->id }}" class="btn btn-dark" style="margin-left:65px">Ver más</a>
                    </div>
                </div>
            </div>
